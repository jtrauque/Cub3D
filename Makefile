...
#    Updated: 2021/01/22 19:15:57 by jtrauque         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME      = Cub3D

SRCS      = main.c color.c map.c parsing.c text.c tools.c graph.c key.c ft_split.c raycasting.c sprite.c hook.c bitmap.c player.c map2.c tools2.c mini_map.c gun.c
